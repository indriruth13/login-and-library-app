  ...
  <div>
    ...
    >
      <div class="d-flex flex-column align-center justify-center">
        ...
        <v-btn small class="mt-7 add-button" elevation="2">
      ...
      <v-list class="mt-13">
        ...
        >
          <div v-if="!item.children" class="d-flex">
            <v-list-item class="px-8 text-bolder">
              <v-list-item-icon>
          ...
          <div v-else class="w-full">
            ...
            <div v-if="toggleMenu">
              <v-list-item 
                ...
                class="pl-8"
              >
                <div v-if="!list.children || list.children.length == 0" class="d-flex px-4">
                ...
                <div v-else class="pl-4">
                  <v-list-item 
                    @click="showGrandChildren(list, i)" 
                    :class="{active:toggleChildren}"
                    class="text-bolder-darker"
                  >
                    <v-list-item-icon>
                  ...
                  <div v-if="toggleChildren" class="pl-4">
                    <v-list-item 
...
export default {
  ...
  created(){
    axios.get('store/sidebar/data.json')
    .then((response) => {
    ...
    axios.get('store/library/data.json')
    .then(response => {
      response.data.map( item => {
