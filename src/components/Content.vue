  ...
  <v-container class="py-10 pl-10 content-container">
    ...
    >
      <v-list-item class="px-2 pt-12">
        ...
        <v-list v-model="mini" class="top-option">
      ...
      <div>
        <div class="d-flex flex-wrap">
          <drag
            ...
            :key="data.id"
            class="mr-6 pa-2"
            :class="{active: data.id == activeItem}"
            :transfer-data="data"
            :effect-allowed="['move']"
				    drop-effect="move"
          >
            <div class="item-content flex-1" @click="showDetail(data)">
              <img src="../assets/google-docs-icon.png" alt="Folder" v-if="data.file_type =='docx'">
              <img src="../assets/google-slides-icon.png" alt="Folder" v-else>
      ...
      <div>
        <div class="d-flex flex-wrap">
          <drop
            ...
            :class="{active: data.id == activeItem, drag: over}"
